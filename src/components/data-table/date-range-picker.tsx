"use client";
import { useDateRangeFromSearchParams } from "@/hooks/use-date-range-from-url";
import { formatDateRangeForParams } from "@/lib/date";
    ...
    <div className={cn("flex flex-col-reverse md:flex-row gap-1", className)}>
      ...
      {hasDateParams ? (
        <Button
          ...
          className="text-xs h-9 md:h-8 shrink-0"
        >
          Clear Filter
        </Button>
      ) : null}
